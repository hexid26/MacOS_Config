# Generated by Powerlevel10k configuration wizard on 2019-10-18 at 00:00 CST.
...
# angled separators, sharp heads, flat tails, 2 lines, solid, no frame, dark, sparse,
# many icons, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='grey78'
  # Make the icon bold.
  ...
  POWERLEVEL9K_CONTEXT_DEFAULT_BACKGROUND='blue1'
